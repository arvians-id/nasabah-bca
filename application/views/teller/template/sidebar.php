<div class="wrapper">
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components text-secondary">
            <li>
                <a href="<?= base_url() ?>teller" <?= in_array($this->uri->segment(2), ['', 'lihatnasabahtgl']) ? 'class="active"' : '' ?>><i class="fas fa-home"></i> Dashboard</a>
            </li>
            <li>
                <a href="<?= base_url() ?>teller/nasabah" <?= in_array($this->uri->segment(2), ['nasabah', 'detailnasabah', 'ubahnasabah', 'create_transaksi', 'final_transaksi']) ? 'class="active"' : '' ?>><i class="fas fa-file-alt"></i> Nasabah</a>
            </li>
            <li>
                <a href="<?= base_url() ?>teller/transaksi" <?= in_array($this->uri->segment(2), ['transaksi', 'ubahtransaksi']) ? 'class="active"' : '' ?>><i class="fas fa-book"></i>
                    Transaksi</a>
            </li>
            <li>
