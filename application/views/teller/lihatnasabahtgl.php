                ...
                <div class="card">
                    <div class="content">
                        <div class="head">
                            ...
                            <a href="<?= base_url('admin') ?>" class="badge badge-primary">Kembali</a>
                        </div>
                        <div class="canvas-wrapper">
                            <table class="table no-margin bg-lighter-grey" id="datatables">
                                ...
                                <tfoot>
                                    <tr>
                                        <td>#</td>
                                        <td colspan="5" class="text-right"><strong>Jumlah Transaksi</strong></td>
                                        <td><?= $total ?></td>
                                    </tr>
                                    <tr>
                                        <td>#</td>
                                        <td colspan="5" class="text-right"><strong>Jumlah Nasabah</strong></td>
